...
Uma minitransação é uma primitiva que aplicações podem utilizar para ler e, condicionalmente, modificar dados em um ambiente distribuído garantindo atomicidade, consistência, isolamento e durabilidade \cite{sinfonia}. A minitransação pode ser vista como uma otimização do procolo de efetivação de duas fases descrito em \ref{subsec:2pc}.
